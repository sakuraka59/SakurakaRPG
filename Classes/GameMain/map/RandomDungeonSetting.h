...
// map size
public: static const int _MAP_WIDTH = 16 * 2;
public: static const int _MAP_HEIGHT = 9 * 2;
public: static const int _MAP_FRAME_NUM = 1;

// 部屋数
public: static const int _ROOM_MIN = 5;
public: static const int _ROOM_MAX = 10;

public: static const int _ROOM_MIN_WIDTH = 5;
public: static const int _ROOM_MIN_HEIGHT = 5;
public: static const int _ROOM_MAX_WIDTH = 13;
