...
public: CharaPlayer(GameCamera* camera, PlayerCommentUI* comment_ui_obj, std::list<CharaBase*> all_chara_list, SkillList* skill_list, std::list<MagicBase*> magic_list, ShadowObjectList* shadow_list);
