#include "SlashTemplate3.h"
//#include "../../hit/HitCircle.h"

#include <math.h>
#include "../../../../../chara/CharaBase.h"

SlashTemplate3::SlashTemplate3(CharaBase* chara_obj, int attack_range, int attack_speed) : EffectBase(chara_obj){
	this->_anime_range = attack_range - 16;	// 16はパーティクルの半分のサイズ
	this->_anime_time = attack_speed;
	this->_frame_end_time = this->_anime_time + 10;
}

void SlashTemplate3::magicInitExtend() {
	// 描画の準備
...
void SlashTemplate3::UpdateDetail() {
