...
private: int _gauge_height = 20;
private: int _gauge_width = 500;
...
public: DefaultStateGauge(CharaPlayer* player_obj, mainStateType main_type, mainStateType sexual_type);
public: void Update();
